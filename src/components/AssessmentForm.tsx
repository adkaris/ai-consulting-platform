...
import { Check, ChevronRight, ChevronLeft, Building2, Send } from 'lucide-react'
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            assessmentData.forEach(domain => {
                const weightedAvg = calculateWeightedScore(domain as any, scores)
            ...
            <div className="flex items-center justify-between border-b border-slate-200 pb-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Discovery Phase: Evaluating readiness across {assessmentData.length} domains</p>
                    </div>
                </div>
